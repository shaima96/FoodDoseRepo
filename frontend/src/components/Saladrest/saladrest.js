        ...
        <div class='container'>
            ...
            <table class='salad' align="center">
                <tr>
                    ...
                    <td onClick={() => { window.location.href = '/fastfoodres/salad/fklmefkmrm65f45sf456sd' }}><img src={"https://scontent.fjrs4-1.fna.fbcdn.net/v/t1.0-9/1069132_170807139768518_1523666347_n.jpg?_nc_cat=106&ccb=2&_nc_sid=05277f&_nc_ohc=J3N21fisw98AX_0d6On&_nc_ht=scontent.fjrs4-1.fna&oh=a09f8d3d7a000697063829b1cd550184&oe=5FDAB269"} alt="img" class="imag" /></td>
                    <td onClick={() => { window.location.href = '/fastfoodres/salad/lkflkne5ds4fs5df4a556d' }}><img src={"https://scontent.fjrs4-1.fna.fbcdn.net/v/t31.0-0/c34.0.206.206a/p206x206/12748145_911752692275853_4070073567893556458_o.jpg?_nc_cat=106&ccb=2&_nc_sid=174925&_nc_ohc=dnqR5yHeRogAX-At8BX&_nc_ht=scontent.fjrs4-1.fna&tp=27&oh=95b92c91e1fecde001895f4c5e6cf84e&oe=5FDD3DC7"} alt="img" class="imag" /></td>
                ...
                <tr>
                    ...
                    <th class="text-center" onClick={() => { window.location.href = '/fastfoodres/salad/jooj5649fd4sdjjngdf555' }} >Roza</th>
                    <th class="text-center" onClick={() => { window.location.href = '/fastfoodres/salad/fklmefkmrm65f45sf456sd' }}>Hebron Sky</th>
                    <th class="text-center" onClick={() => { window.location.href = '/fastfoodres/salad/lkflkne5ds4fs5df4a556d' }}>Queen Plaza</th>
                ...
                <tr>
                    ...
                    <th class="text-center" onClick={() => { window.location.href = '/fastfoodres/salad/jdfhjksdjk56515645sdf6' }}>Hawana</th>
                    <th class="text-center" onClick={() => { window.location.href = '/fastfoodres/royal/5frmweflm,145236878778' }}>Sofraji</th>
                    <th class="text-center" onClick={() => { window.location.href = '/fastfoodres/salad/fpjefwpkf54e657e564r8' }}>Villa</th>
                </tr>
            </table>
